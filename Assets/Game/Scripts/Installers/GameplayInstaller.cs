...
namespace Game.Scripts.Installers
{
    public class GameplayInstaller : MonoInstaller
    {
        ...
        public override void InstallBindings()
        {
            ...
            globalWorkersObserverInstance.RegisterPlayer(playerInstance.OwnerId);
            globalWorkersObserverInstance.RegisterPlayer(aiPlayer.OwnerId);
            globalUpgradesManager.RegisterPlayer(playerInstance.OwnerId);
            globalUpgradesManager.RegisterPlayer(aiPlayer.OwnerId);
            globalBuildingsStagesController.RegisterNewPlayer(playerInstance.OwnerId, 0);
            globalBuildingsStagesController.RegisterNewPlayer(aiPlayer.OwnerId, 0);
